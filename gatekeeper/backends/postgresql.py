...
from sqlalchemy import create_engine, Column, String, Integer, Boolean, DateTime, Text, JSON, text
        ...
        with self._get_session() as session:
            try:
                ...
                if user_update.username is not None:
                    ...
                    if existing:
                        raise UserAlreadyExistsError(f"Username '{user_update.username}' already exists")
                ...
                if user_update.email is not None:
                    ...
                    if user_update.email:
                        ...
                        if existing:
                            raise UserAlreadyExistsError(f"Email '{user_update.email}' already exists")
