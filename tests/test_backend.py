...
from gatekeeper.backends.base import BackendError, UserNotFoundError, UserAlreadyExistsError
...
class TestMemoryBackend:
    ...
    async def test_list_users(self, memory_backend):
        ...
        user1 = User(id="1", username="user1", email="user1@example.com", role=UserRole.REGULAR, password_hash="hash1")
        user2 = User(id="2", username="user2", email="user2@example.com", role=UserRole.ADMIN, password_hash="hash2")
    ...
    async def test_count_users(self, memory_backend):
        ...
        user = User(id="1", username="user1", email="user1@example.com", role=UserRole.REGULAR, password_hash="hash1")
        await memory_backend.create_user(user)
    ...
    async def test_update_user_password(self, memory_backend, sample_user):
        ...
        success = await memory_backend.update_user_password(sample_user.username, "new_hash")
    ...
    async def test_update_user_role(self, memory_backend, sample_user):
        ...
        success = await memory_backend.update_user_role(sample_user.username, UserRole.ADMIN)
    ...
    async def test_update_user_metadata(self, memory_backend, sample_user):
        ...
        success = await memory_backend.update_user_metadata(sample_user.username, metadata)
    ...
    async def test_search_users(self, memory_backend):
        ...
        user1 = User(id="1", username="john_doe", email="john@example.com", role=UserRole.REGULAR, password_hash="hash1")
        user2 = User(id="2", username="jane_smith", email="jane@example.com", role=UserRole.ADMIN, password_hash="hash2")
        user3 = User(id="3", username="bob_wilson", email="bob@example.com", role=UserRole.REGULAR, password_hash="hash3")
    ...
    async def test_get_users_by_role(self, memory_backend):
        ...
        user1 = User(id="1", username="user1", email="user1@example.com", role=UserRole.REGULAR, password_hash="hash1")
        user2 = User(id="2", username="user2", email="user2@example.com", role=UserRole.ADMIN, password_hash="hash2")
        user3 = User(id="3", username="user3", email="user3@example.com", role=UserRole.REGULAR, password_hash="hash3")
    ...
    async def test_get_user_settings(self, memory_backend, sample_user):
        ...
        # Set some settings
        memory_backend._settings[sample_user.id] = {"theme": "dark", "notifications": True}
    ...
    async def test_update_user_settings(self, memory_backend, sample_user):
        ...
        success = await memory_backend.update_user_settings(sample_user.username, new_settings)
